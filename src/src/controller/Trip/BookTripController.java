...
public class BookTripController extends Controller<Trip> {
	...
	@FXML
	private ListView<Itinery> itineryListView;
	...
	private void addDestination(ActionEvent event) {
		try {
			ViewLoader.showStage(model.getAgency(), "/view/Destinations/AddDestinationView.fxml", "Add a Destination", addfStage);
	...
	private void removeDestination(ActionEvent event) {
		try {
			ViewLoader.showStage(model.getAgency(), "/view/Destinations/RemoveDestinationView.fxml", "Remove a Destination", removefStage);
	...
	private void viewTrip(ActionEvent event) {
		try {
			ViewLoader.showStage(model, "/view/Trip/DisplayTripView.fxml", "View Trip", viewTripStage);
